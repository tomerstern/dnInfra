...
// import { GridColumn, GridDefinitions, GridColumnType, GridColumnParams } 
...
//   DpMenuItem,
//   DpMessageService,
} from 'projects/dn-infra/src/lib/dp/components/splitbutton/objects/splitbutton-definitions';
...
//   items1: DpMenuItem[];
  ...
  ngOnInit(): void {
    ...
    this.gridDefinition3 = new GridDefinitions({
      dataKey: 'product',
      columns: columns3,
      HeadersMergeGroupsHtml:
        '<tr><th colspan="7" >Supplier Details</th>' +
  ...
  getColumns3() {
    ...
    const column11 = new GridColumn({
      headername: 'Remarks/Last Status ',
      fieldname: 'h11',
  ...
  getData() {
    this.gridData3 = [
      {
        product: '4200114435435',
        lastYearSale: '24/06/2017',
        thisYearSale: '-',
        lastYearProfit: 'INTEL ELECTRICITY',
        thisYearProfit: 'TOSOH SHFFHKJHH LONGTEXT',
        h7: 'HOUSTON',
        h8: 'USA',
        h9: 'TLV1458999',
        h10: 'TLV1458999',
