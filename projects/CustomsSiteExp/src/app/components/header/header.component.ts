...
// import { MenubarDefinitions, DpMenuItem } from '';
...
export class HeaderComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    // debugger;
    // try {
    //   this.userService.sp_General('895', '9')
  ...
  getTestData() {
    ...
    this.itemsTest = [
      ...
      {
        label: 'Declaration',
        routerLink: ['/declaration', {ShipmentNumber: 10001000, DeptCode: "1", CusDecOrder: 12, declarationMode: 'UPDATE'}]
      },
      {
        label: 'COO',
