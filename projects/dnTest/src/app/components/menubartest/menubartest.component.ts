...
import { MenubarDefinitions } from 'projects/dn-infra/src/lib/dp/components/menubar/Objects/menubar-definitions';
...
export class MenubartestComponent implements OnInit {
  ...
  getData() {
    ...
    this.items3 = [
      {
          label: 'url', styleClass: 'mItem_1_0',
          url: 'http://www.primefaces.org/primeng'
      },
      {
          label: 'routerLink',  styleClass: 'mItem_2_0',
